enrollments-crud-title       = Заявления
enrollments-crud-description = Список заявок на зачисление

enrollments-student          = Студент
enrollments-course  = Курс
enrollments-group   = Группа


enrollments-accept  = Зачислить
